...
public class DivInputFileRenderer extends InputFileRenderer {
	...
	private boolean isDivStyleClassSet(UIComponent component) {
		if (component instanceof HtmlDivInputFile) {
			HtmlDivInputFile divInputText = (HtmlDivInputFile) component;
	...
	private String getDivStyleClass(UIComponent component) {
		return ((HtmlDivInputFile) component).getDivStyleClass();
	}
}
