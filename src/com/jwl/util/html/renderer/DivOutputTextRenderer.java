...
public class DivOutputTextRenderer extends TextRenderer {
	...
	private boolean isDivStyleClassSet(UIComponent component) {
		if (component instanceof HtmlDivOutputText) {
			HtmlDivOutputText divInputText = (HtmlDivOutputText) component;
	...
	private String getDivStyleClass(UIComponent component) {
		return ((HtmlDivOutputText) component).getDivStyleClass();
	}
}
